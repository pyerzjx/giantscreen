...
from utils.dbutils import admin_session
from app.webapi.model import Cwebapi
from app.webapi.model import Datasource
...
admin.add_view(UserView(User, admin_session, name=u'用户管理'))
admin.add_view(ApiView(Cwebapi, admin_session, name=u'API管理', category="接口管理"))
admin.add_view(SourceView(Datasource, admin_session, name=u'数据源管理', category="接口管理"))
